...
export class Migration20240515110000_create_travels_table extends Migration {
  ...
  async up(): Promise<void> {
    this.addSql('CREATE TABLE "travels" ("id" UUID NOT NULL,' +
    ...
    this.addSql('ALTER TABLE "travels" ADD CONSTRAINT "travels_slug_unique" UNIQUE ("name");');
    this.addSql('ALTER TABLE "travels" ADD CONSTRAINT "travels_name_unique" UNIQUE ("name");');
